...
export default function Loading() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[400px] bg-[var(--af-bg)]">
      ...
      <svg className="animate-spin h-8 w-8 text-[var(--af-accent)] mb-4" fill="none" viewBox="0 0 24 24">
