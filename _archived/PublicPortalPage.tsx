/**
 * ARCHIVED — Public expense portal (form + guest track status).
 * Disabled: app now uses a login-only landing page at app/page.tsx.
 * Kept for reference if public submission needs to be restored.
 */
"use client";
